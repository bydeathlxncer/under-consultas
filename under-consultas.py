...
lz='\033[34m'   
def ip():  
    n1 = str(input(f'{vm}-->{f}{az}[consultar IP]{f}\n\n- {az}[{f}{lz}01{f}{az}]{f} {ng}ipporlocalização{f}\n- {az}[{f}{lz}02{f}{az}]{f} {ng}ip{f}\n- {az}[{f}{lz}03{f}{az}]{f} {ng}ipfind{f}  \n- {am}-->{f} '))         
    if n1=='1' or n1=='01':
        ip1=input(f'{vm}-->{f}{az}[fonte IPporlocalização]{f} \n{vm}-->{f}{az}[ ip ]{f} {am}-->{f} ')
...
def cep():    
    ...
    if n1=='1' or n1=='01':
        ...
        if len(cep1) == 8:
            ...
            print(f' {vm}[*] você coloco errada carai \coloca o bagulho certo ai crl \n {f}ex: {ng}01001000 {f}')                                 
    elif n1=='2' or n1=='02':
        ...
        if len(cep2)==8:
            ...
            print(f' {vm}[*] você colocou errado carai \coloca o bagulho certo ai crl \n {f}ex: {ng}01001000 {f}')
    elif n1=='3' or n1=='03':
        ...
        if len(cep3) == 8:            
            ...
            print(f' {vm}[*] você colocou errado carai \coloca o bagulho certo ai crl \n {f}ex: {ng}01001000 {f}')            
def cnpj():    
    cpnj1=input(f'{vm}-->{f}{az}[fonte receita federalkkk ]{f} \n{vm}-->{f}{az}[ cpnj ]{f} {am}-->{f} ')                           
...
def ban():
 ...
 {f} - {vd}bydeathlxncer{f}
 {az}{f}	                            
{vm}  {vd} under-consultas {f}   
  """)
os.system('clear');
def menu():
    print(f"""
...
::::: ::   ::   ::   :::: ::   :: ::::  ::   :::
 : :  :   ::    :   :: :  :   : :: ::    :   : :
             script criado para consultas
a arte de escutar é como uma luz que dissipa a escuridão da ignorância
 {f}{vd}bydeathlxncer{f}
 
    	 	       
* {az}[{f}{lz}01{f}{az}]{f} {vd}consulta por IP{f}
* {az}[{f}{lz}02{f}{az}]{f}{vd} consulta por CEP {f}
* {az}[{f}{lz}03{f}{az}]{f} {vd}consulta por CNPJ {f}
* {az}[{f}{lz}04{f}{az}]{f} {vd}vazar do script{f}
    """)
try:
    menu()
    ...
    print(f'{vm}* [!!!] coloca o bagulho certo caraikkkk {f}')
try:    
